# `libgeotiff_jll.jl` (v100.702.301+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5817f32354b7bacbd985d0148f30be47d2511f41/L/libgeotiff/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/OSGeo/libgeotiff.git (revision: `d2c72dba35ac9d1af2201191064ca4cbe7f57f11`)
